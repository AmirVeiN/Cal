            ...
            <TouchableOpacity
              onPress={() => {
                if (e.item[0].split(" ")[1] === "res")
                  resultHandler(eval(top)), topHandler(eval(top));
                else if (e.item[0].split(" ")[1] === "C")
                  topHandler(""), resultHandler("");
                else if (e.item[0].split(" ")[1] === "backSpace") removeLast();
                else addList(e.item[0].split(" ")[1]);
              }}
              className={`${
                e.item[0].split(" ")[1] === "res" && " rounded-full bg-black"
